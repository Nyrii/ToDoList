...
/**
 * Created by noboud_n on 22/01/2017.
 */
...
public class TaskDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton doneButton = (FloatingActionButton) findViewById(R.id.doneActionButton);
    ...
    public void retrieveTextViews() {
        _titleTextView = (TextView)findViewById(R.id.titleLabel);
        _descTextView = (TextView)findViewById(R.id.description_details);
        _dateTextView = (TextView)findViewById(R.id.dueDate_details);
        _statusTextView = (TextView)findViewById(R.id.status_details);
    }
